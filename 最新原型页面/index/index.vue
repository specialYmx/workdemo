<template>
  <div class="page flex-col">
    <div class="box_1 flex-row">
      ...
      <span class="text_2">法规汇编</span> <span class="text_3">新规解读</span>
      <span class="text_4">处罚汇编</span> <span class="text_5">处罚汇编</span>
      <span class="text_6">研究集锦</span>
      <span class="text_7">法律合规季刊</span>
      <span class="text_8">智库更新</span> <span class="text_9">人工审核</span>
      <img
        class="label_1"
        referrerpolicy="no-referrer"
    ...
    <div class="box_2 flex-col">
      <div class="box_3 flex-col">
        <div class="text-wrapper_2 flex-row">
          <span class="text_10">首页概览仪表盘</span>
        </div>
        <div class="group_1 flex-row">
          <div class="text-wrapper_3 flex-col">
            <span class="text_11">本月</span>
          </div>
          <div class="text-wrapper_4 flex-col">
            <span class="text_12">本季</span>
          </div>
          <div class="text-wrapper_5 flex-col">
            <span class="text_13">本年</span>
          </div>
          <div class="text-wrapper_6 flex-col">
            <span class="text_14">导出报告</span>
          </div>
        </div>
        <div class="group_2 flex-row justify-between">
          <div class="box_4 flex-row">
            <div class="text-wrapper_7 flex-col justify-between">
              <span class="text_15">本月法规更新</span>
              <span class="text_16">1352</span>
            </div>
            <img
              class="image_2"
              referrerpolicy="no-referrer"
          ...
          <div class="box_5 flex-row">
            <div class="text-wrapper_8 flex-col justify-between">
              <span class="text_17">待人工审核</span>
              <span class="text_18">231</span>
            </div>
            <img
              class="image_3"
              referrerpolicy="no-referrer"
          ...
          <div class="box_6 flex-col">
            <div class="box_7 flex-row justify-between">
              <span class="text_19">法规更新趋势</span>
              <div class="block_1 flex-row">
                <span class="text_20">月度</span>
                <img
                  class="thumbnail_1"
                  referrerpolicy="no-referrer"
        ...
        <div class="group_6 flex-row">
          <span class="text_25">近期完成审核</span>
          ...
          <div class="image-text_1 flex-row justify-between">
            ...
            <div class="text-group_1 flex-col justify-between">
              ...
              <div class="text-wrapper_10 flex-row">
                <span class="text_29">完成日期:&nbsp;2024-01-18</span>
                <span class="text_30">状态：</span>
                <span class="text_31">已批准</span>
              </div>
            </div>
          </div>
          ...
          <div class="image-text_2 flex-row justify-between">
            ...
            <div class="text-group_2 flex-col justify-between">
              ...
              <div class="text-wrapper_11 flex-row">
                <span class="text_35">完成日期:&nbsp;2024-01-18</span>
                <span class="text_36">状态：</span>
                <span class="text_37">已驳回</span>
              </div>
            </div>
          </div>
        ...
        <div class="group_12 flex-row">
            ...
            <div class="image-text_3 flex-row justify-between">
              ...
              <div class="text-group_3 flex-col justify-between">
                ...
                <div class="text-wrapper_12 flex-row">
                  <span class="text_40">完成日期:&nbsp;2024-01-18</span>
                  <span class="text_41">状态：</span>
                  <span class="text_42">已批准</span>
                </div>
              </div>
            </div>
          ...
          <div class="group_15 flex-col">
            ...
            <div class="text-wrapper_14 flex-row justify-between">
              ...
              <span class="text_49">5日</span> <span class="text_50">6日</span>
              <span class="text_51">7日</span>
            </div>
          </div>
        </div>
      ...
      <div class="box_21 flex-col">
        <div class="box_22 flex-row justify-between">
          <span class="text_52">Top&nbsp;5&nbsp;需要人工审核</span>
          <div class="text-wrapper_15 flex-col">
            <span class="text_53">查看全部</span>
          </div>
        </div>
        ...
        <div class="box_24 flex-row">
          <div class="text-wrapper_16">
            <span class="text_60">关于保险资金投资股权的合规审查报告</span>
            <span class="text_61">文号：合规审[2024]001号</span>
          </div>
          <span class="text_62">综合类</span>
          <span class="text_63">人民银行网站</span>
          <span class="text_64">2025-07-01&nbsp;15:10:35</span>
          <span class="text_65">待审核</span> <span class="text_66">查看</span>
        ...
        <div class="box_26 flex-row">
          <div class="text-wrapper_17">
            ...
            <span class="text_71">文号：合规审[2024]001号</span>
          </div>
          <span class="text_72">机构监管</span>
          <span class="text_73">证监会公告</span>
          <span class="text_74">2025-07-01&nbsp;15:10:35</span>
          <span class="text_75">待审核</span> <span class="text_76">查看</span>
        ...
        <div class="box_28 flex-row">
          <div class="text-wrapper_18">
            ...
            <span class="text_81">文号：合规审[2024]001号</span>
          </div>
          <span class="text_82">公司治理</span>
          <span class="text_83">财政部通知</span>
          <span class="text_84">2025-07-01&nbsp;15:10:35</span>
          <span class="text_85">待审核</span> <span class="text_86">查看</span>
        ...
        <div class="box_30 flex-row">
          <div class="text-wrapper_19">
            ...
            <span class="text_91">文号：合规审[2024]001号</span>
          </div>
          <span class="text_92">风控合规</span>
          <span class="text_93">交易所规则</span>
          <span class="text_94">2025-07-01&nbsp;15:10:35</span>
          <span class="text_95">待审核</span> <span class="text_96">查看</span>
        ...
        <div class="box_32 flex-row">
          <div class="text-wrapper_20">
            ...
            <span class="text_101">文号：合规审[2024]001号</span>
          </div>
          <span class="text_102">运营与信息统计</span>
          <span class="text_103">行业协会</span>
          <span class="text_104">2025-07-01&nbsp;15:10:35</span>
          <span class="text_105">待审核</span>
      ...
      <div class="box_34 flex-col">
        <div class="text-wrapper_21 flex-row">
          <span class="text_110">法规更新来源分布</span>
        </div>
        <div class="group_37 flex-row justify-end">
            ...
            <div class="section_17 flex-row justify-between">
              ...
              <div class="box_37 flex-col">
                <div class="block_8 flex-row">
                  <span class="text_113">人民银行网站</span>
                  <img
                    class="thumbnail_3"
                    referrerpolicy="no-referrer"
                ...
                <div class="block_9 flex-row">
                  <span class="text_115">证监会公告</span>
                  <img
                    class="thumbnail_4"
                    referrerpolicy="no-referrer"
                    src="https://lanhu-oss-2537-2.lanhuapp.com/SketchPng54a0ad01c905d65149bbef8686a38fe7b0d823970cd2c46ed3ef20bf218ed58a"
                ...
                <div class="block_10 flex-row">
                  <span class="text_117">财政部通知</span>
                  <img
                    class="thumbnail_5"
                    referrerpolicy="no-referrer"
                    src="https://lanhu-oss-2537-2.lanhuapp.com/SketchPng8a248079747cf3f89a297e1c1725996ab539d45899fd6aa66044bc5549f74172"
          ...
          <div class="group_44 flex-col">
            <div class="section_22 flex-row justify-end">
              <div class="box_39 flex-row">
                <span class="text_119">国家金融监督管理总局机构</span>
                <img
                  class="thumbnail_6"
                  referrerpolicy="no-referrer"
                  src="https://lanhu-oss-2537-2.lanhuapp.com/SketchPng8a248079747cf3f89a297e1c1725996ab539d45899fd6aa66044bc5549f74172"
    ...
    <div class="box_40 flex-col">
      <div class="box_41 flex-row justify-between">
        <span class="text_125">最新法规更新</span>
        <div class="text-wrapper_22 flex-col">
          <span class="text_126">查看全部</span>
        </div>
      </div>
      ...
      <div class="box_42 flex-col">
        ...
        <div class="text-wrapper_28 flex-row justify-between">
          <span class="text_148">偿付能力</span>
          <span class="text_149">征求意见</span>
