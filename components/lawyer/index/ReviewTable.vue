<template>
    <a-card class="lawyer-chart-card" :bordered="false" style="margin-bottom: 24px" title="Top 5 需要人工审核">
        <template slot="extra">
        ...
        <a-spin :spinning="loading">
            ...
            <a-table v-else :columns="reviewColumns" :data-source="reviews" :pagination="false" size="middle"
                class="lawyer-review-table" row-key="id">
                ...
                <template slot="action" slot-scope="text, record">
                    <div class="lawyer-action-links">
                        ...
                        ">
                            <a class="lawyer-link-approve" @click="approveItem(record)">
                                通过
                            </a>
                            <a class="lawyer-link-reject" @click="rejectItem(record)">
                                驳回
                            </a>
                        </template>
                    </div>
