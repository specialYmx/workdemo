    ...
    <a-card class="lawyer-chart-card" :bordered="false" title="法规更新来源分布">
        <div class="lawyer-pie-chart-layout">
            <div class="lawyer-pie-chart-container">
                ...
                <lawyer-common-chart-component v-else :options="pieChartOptions" :loading="loading"
                    :auto-resize="true" />
            </div>
            <div class="lawyer-pie-legend-container">
                <div v-for="(item, index) in legendItems" :key="index" class="lawyer-pie-legend-item"
