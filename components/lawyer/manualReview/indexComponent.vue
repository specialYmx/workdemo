            ...
            <div class="lawyer-main-card">
                ...
                <div class="lawyer-controls-row">
                    ...
                    <div class="lawyer-filter-select">
                        <a-select v-model="filterType" placeholder="请选择分类" allow-clear @change="onFilterChange">
                    ...
                    <a-button class="lawyer-btn-export" :disabled="selectedRowKeys.length === 0" @click="exportData">
...
export default class LawyerManualReviewIndexComponent extends Vue {
    ...
    async loadDocuments(): Promise<void> {
        ...
        try {
            ...
            // 调用后端分页接口
            const response = await this.$roadLawyerService.getRuleList(
                params,
                'management'
            )
