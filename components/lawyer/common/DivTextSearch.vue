    ...
    <div class="lawyer-div-text-search-container">
        <div class="lawyer-search-bar">
            <div class="lawyer-search-box">
                <input v-model="searchTerm" type="text" placeholder="搜索..." class="lawyer-detail-search-input"
                    @keyup.enter="onSearch">
                <a-button v-if="searchTerm" type="link" class="lawyer-clear-button" icon="close" size="small"
                    @click="clearSearch" />
